        ...
        <>
            <div className="bg-[#F7F6F9] w-screen h-screen">
                ...
                <div className='flex gap-6 justify-center text-gray-700'>
                    ...
                    <div className=' h-[25vh] w-[26vw] rounded-md border-solid border-[1px] border-gray-300 bg-white box-border'>
                        <h1 className='mt-6 ml-4'>Current value</h1>
                        <h3 className='ml-5 mt-1 text-[2.5vw] text-black font-bold'>₹{Number(current.toFixed(2))}</h3>
                    </div>

                    <div className=' h-[25vh] w-[26vw] rounded-md border-solid border-[1px] border-gray-300 bg-white'>
                        <h1 className='mt-6 ml-4'> Total Invested</h1>
                        <h3 className='ml-5 mt-1 text-[2.5vw] text-black font-bold'>₹{invested}</h3>

                    </div>

                    <div className=' h-[25vh] w-[26vw] rounded-md border-solid border-[1px] border-gray-300 bg-white'>
                        <h1 className='mt-6 ml-4'>Total Returns</h1>
                        <h3 className='ml-5 mt-1 text-[2.5vw] font-bold inline-flex align-middle' style={{ color: (pl) >= 0 ? "green" : "red" }}>₹{pl.toFixed(2)}</h3>
                        <h3 className={`ml-3 px-2 rounded-lg inline-flex align-middle ${pl>=0 ? "bg-green-100":"bg-red-100"}`}>{percent}%</h3>
                    </div>

                </div>

                <div className=' w-screen flex justify-center mt-8'>
                    <div className='w-[90vw] ml-2 rounded-md border-solid border-[1px] border-gray-300 bg-white mt-2'>
                        <h1 className='ml-5 my-4 text-xl font-normal'>My Holdings</h1>
                        <ul className="grid grid-cols-6 text-center font-semibold py-2 text-gray-600">
                            <li>Name</li>
                            <li>Quantity</li>
                            <li>Buy Avg.</li>
                            <li>Current value</li>
                        ...
                        {holdings.map((value, index) => (
                            <Link to={`/stocks/${value.stock}`} key={index}>
                                <ul className="grid grid-cols-6 text-center py-3 hover:bg-gray-50 cursor-pointer">
